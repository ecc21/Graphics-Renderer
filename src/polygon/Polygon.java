...
public class Polygon extends Chain {
	...
	private double specular_k;
	private double specular_p;
	...
	public void setSpecularScalar(double ks) {
		this.specular_k = ks;
	}
	public double getSpecularScalar() {
		return this.specular_k;
	}
	public void setSpecularExonent(double p) {
		this.specular_p = p;
	}
	public double getSpecularExonent() {
		return this.specular_p;
	}
}
