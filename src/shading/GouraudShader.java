...
public class GouraudShader implements Shader {
	...
	public Color shade_pixel(Polygon polygon, Vertex3D current) {
		...
		double r = v0.getColor().getR()*a0/v0.getZ() + v1.getColor().getR()*a1/v1.getZ()  + v2.getColor().getR()*a2/v2.getZ() ;
		double g = v0.getColor().getG()*a0/v0.getZ()  + v1.getColor().getG()*a1/v1.getZ()  + v2.getColor().getG()*a2/v2.getZ() ;
		double b = v0.getColor().getB()*a0/v0.getZ()  + v1.getColor().getB()*a1/v1.getZ()  + v2.getColor().getB()*a2/v2.getZ() ;
		r = r*current.getZ() ;
		g = g*current.getZ() ;
		b = b*current.getZ() ;
